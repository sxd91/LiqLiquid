...
import 'package:liqliquid/pages/audio/controller.dart';
import 'package:liqliquid/pages/audio/volume_button.dart';
...
extension _ListOrderExt on ListOrder {
  String get title => const ['鏃犲簭', '姝ｅ簭', '鍊掑簭', '闅忔満'][value];
}
            ...
            children: [
              ...
              if (_controller.player case final player?) ...[
                ListTile(
                  ...
                  title: const Text('鎾斁淇℃伅', style: TextStyle(fontSize: 14)),
                  onTap: () {
                    Get.back();
