...
import 'package:liqliquid/pages/dynamics_create_vote/controller.dart';
...
class _CreateVotePageState extends State<CreateVotePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('${_controller.voteId != null ? '' : '鍙戣捣'}鎶曠エ'),
      ),
      body: ListView(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              SizedBox(
                width: 100,
                child: Text('鍗曢€?澶氶€?, style: _leadingStyle),
              ),
              Obx(() {
                ...
                return Listener(
                  ...
                  child: PopupMenuButton<int>(
                    ...
                    requestFocus: false,
                    child: Text(
                      choiceCnt == 1 ? '鍗曢€?        ' : '鏈€澶氶€?choiceCnt椤?,
                    ),
          ...
          Row(
            ...
            children: [
              SizedBox(
                width: 100,
                child: Text('鎶曠エ鎴鏃堕棿', style: _leadingStyle),
              ),
              GestureDetector(
