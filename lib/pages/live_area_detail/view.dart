...
import 'package:liqliquid/pages/live_area_detail/child/view.dart';
import 'package:liqliquid/pages/live_area_detail/controller.dart';
import 'package:liqliquid/pages/live_search/view.dart';
                  ...
                  Row(
                    children: [
                      ...
                      iconButton(
                        iconSize: 20,
                        tooltip:
                            '鍒囨崲${_controller.showFirstFrame ? '灏侀潰' : '棣栧抚'}',
