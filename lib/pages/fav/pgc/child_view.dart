import 'package:liqliquid/common/skeleton/fav_pgc_item.dart';
...
import 'package:liqliquid/pages/fav/pgc/widget/item.dart';
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    const Spacer(),
                    ...const [
                          (followStatus: 1, title: '鎯崇湅'),
                          (followStatus: 2, title: '鍦ㄧ湅'),
                          (followStatus: 3, title: '鐪嬭繃'),
                        ]
                        .where(
