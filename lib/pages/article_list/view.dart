...
import 'package:liqliquid/models_new/article/article_list/list.dart';
import 'package:liqliquid/pages/article_list/controller.dart';
import 'package:liqliquid/pages/article_list/widgets/item.dart';
                ...
                children: [
                  ...
                  Text.rich(
                    TextSpan(
                      children: [
                        TextSpan(
                          text: '${NumUtils.numFormat(item.articlesCount)}绡囦笓鏍?,
                        ),
                        divider,
                        TextSpan(text: '${NumUtils.numFormat(item.words)}涓瓧'),
                        divider,
                        TextSpan(text: '${NumUtils.numFormat(item.read)}娆￠槄璇?),
                      ],
                      style: style,
                    ),
                  ),
